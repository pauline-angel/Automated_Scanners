...
# Example usage
application_url = "https://www.hackthissite.org/"
login_route = "https://www.hackthissite.org/"
protected_route = "playlevel/1/"  # Replace with the actual protected route after login
username = "dibili"
